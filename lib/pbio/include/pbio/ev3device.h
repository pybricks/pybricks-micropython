...
enum {
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__AMBIENT      = 0,
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__REFLECT_R    = 1,
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__REFLECT_G    = 2,
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__REFLECT_B    = 3,
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__REFLECT_RGB  = 4,
    PBIO_IODEV_MODE_NXT_COLOR_SENSOR__COLOR        = 5,
};
