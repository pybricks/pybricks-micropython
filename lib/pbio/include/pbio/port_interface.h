...
static inline pbio_error_t pbio_port_get_analog_value(pbio_port_t *port, lego_device_type_id_t type_id, uint32_t *value, pbio_port_dcm_analog_light_type_t light_type) {
    return PBIO_ERROR_NOT_SUPPORTED;
}
