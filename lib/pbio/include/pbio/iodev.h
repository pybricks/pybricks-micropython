...
typedef enum {
    ...
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__COL_REFLECT   = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 0,
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__COL_AMBIENT   = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 1,
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__COL_COLOR     = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 2,
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__REF_RAW       = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 3,
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__RGB_RAW       = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 4,
    PBIO_IODEV_MODE_ID_EV3_COLOR_SENSOR__COL_CAL       = (PBIO_IODEV_TYPE_ID_EV3_COLOR_SENSOR << 8) | 5,
