...
#define DATA_SIZE ((769 + 7) / 8)

// number of PWM channels on TLC5955
#define NUM_CHANNEL 48
 ...
 */
#define CONTROL_DATA(name, dc, mc, bc, dsprpt, tmgrst, rfresh, espwm, lsdvlt) \
    uint8_t name[DATA_SIZE] = { \
        /* bit 768 */      [0] = 1, \
        /* bits 767-760 */ [1] = 0x96, \
