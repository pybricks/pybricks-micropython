...
// Causes the run loop to execute the next time the bluetooth process wakes
// up. Should be called whenever there might be new information that btstack
// needs to process (e.g. after receiving or sending a packet).
