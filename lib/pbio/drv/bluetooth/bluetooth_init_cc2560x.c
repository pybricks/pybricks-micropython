...
//
// (Look further down for the CC2560A init script.)

static const uint16_t cc2560_init_script_lmp_subversion = 0x191f;
...
// CC2560A init script created from:
// - TIInit_6.6.15.bts
// - AKA TIInit_6.6.15.bts

static const uint32_t cc2560_init_script_size = sizeof(cc2560_init_script); // size = 41270 bytes

static const uint16_t cc2560a_init_script_lmp_subversion = 0x1b0f;
...
static const uint32_t cc2560a_init_script_size = sizeof(cc2560a_init_script); // size = 12243 bytes

pbio_error_t pbdrv_bluetooth_get_init_script(uint16_t lmp_subversion, pbdrv_bluetooth_init_script_t *result) {
    if (lmp_subversion == cc2560_init_script_lmp_subversion) {
        result->script = cc2560_init_script;
        result->script_size = cc2560_init_script_size;
        return PBIO_SUCCESS;
    } else if (lmp_subversion == cc2560a_init_script_lmp_subversion) {
        result->script = cc2560a_init_script;
        result->script_size = cc2560a_init_script_size;
        return PBIO_SUCCESS;
    } else {
