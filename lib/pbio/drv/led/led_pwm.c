...
static pbio_error_t pbdrv_led_pwm_set_hsv(pbdrv_led_dev_t *dev, pbio_color_t hsv) {
    ...
    pbio_color_t hsv2 = PBIO_COLOR_ENCODE(pbio_color_get_h(hsv), pbio_color_get_s(hsv), 100);
    pbio_color_rgb_t rgb;
    pbio_color_to_rgb(hsv2, &rgb);
    ...
    uint32_t scale_factor = pbio_color_get_v_clamped(hsv) * pbio_color_get_v_clamped(hsv) * pdata->scale_factor / 128;
