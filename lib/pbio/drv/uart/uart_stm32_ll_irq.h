...
#ifndef _INTERNAL_PBDRV_UART_STM32_LL_IRQ_H_
#define _INTERNAL_PBDRV_UART_STM32_LL_IRQ_H_
...
typedef struct {
    ...
    IRQn_Type irq;
} pbdrv_uart_stm32_ll_irq_platform_data_t;

/**
 * Array of UART platform data to be defined in platform.c.
 */
extern const pbdrv_uart_stm32_ll_irq_platform_data_t
...
#endif // _INTERNAL_PBDRV_UART_STM32_LL_IRQ_H_
