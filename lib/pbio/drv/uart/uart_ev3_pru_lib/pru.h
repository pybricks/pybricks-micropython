...
extern uint32_t pru_enable(uint8_t pruNum,
    arm_pru_iomap *pru_arm_iomap);
extern uint32_t pru_load(uint8_t pruNum, uint32_t *pruCode,
    uint32_t codeSizeInWords,
    arm_pru_iomap *pru_arm_iomap);
extern uint32_t pru_run(uint8_t pruNum,
    arm_pru_iomap *pru_arm_iomap);
extern uint32_t pru_waitForHalt(uint8_t pruNum, int32_t timeout,
    arm_pru_iomap *pru_arm_iomap);
extern uint32_t pru_disable(arm_pru_iomap *pru_arm_iomap);

int16_t pru_ram_write_data(uint32_t u32offset, uint8_t *pu8datatowrite,
    uint16_t u16wordstowrite,
    arm_pru_iomap *pru_arm_iomap);
int16_t pru_ram_read_data(uint32_t u32offset, uint8_t *pu8datatoread,
    uint16_t u16wordstoread,
    arm_pru_iomap *pru_arm_iomap);
