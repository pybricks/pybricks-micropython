...
typedef struct {
    ...
    volatile uint32_t INTEVAL;
    volatile uint8_t RSVD1[36];
    volatile uint32_t MERRPR0;
    volatile uint8_t RSVD2[12];
    volatile uint32_t MERRCR0;
    volatile uint8_t RSVD3[12];
    volatile uint32_t PERRPR;
    volatile uint8_t RSVD4[4];
    volatile uint32_t PERRCR;
    volatile uint8_t RSVD5[180];
    volatile uint32_t PTCMD;
    volatile uint8_t RSVD6[4];
    volatile uint32_t PTSTAT;
    volatile uint8_t RSVD7[212];
    volatile uint32_t PDSTAT0;
    volatile uint32_t PDSTAT1;
    volatile uint8_t RSVD8[248];
    volatile uint32_t PDCTL0;
    volatile uint32_t PDCTL1;
    volatile uint8_t RSVD9[248];
    volatile uint32_t PDCFG0;
    volatile uint32_t PDCFG1;
    volatile uint8_t RSVD10[1016];
    volatile uint32_t MDSTAT[32];
    volatile uint8_t RSVD11[384];
    volatile uint32_t MDCTL[32];
} CSL_PscRegs;
