...
// In 2026, LEGO started shipping a new version of the SPIKE Prime Hub
// with an STM32H5 series microcontroller which differs from the original
// STM32F4 version, so requires a separate platform configuration/firmware.
...
#define PBDRV_CONFIG_ADC_STM32_HAL_DMA_INSTANCE     GPDMA2_Channel0
#define PBDRV_CONFIG_ADC_STM32_HAL_DMA_REQUEST      LL_GPDMA2_REQUEST_ADC1
#define PBDRV_CONFIG_ADC_STM32_HAL_DMA_IRQ          GPDMA2_Channel0_IRQn
...
#define PBDRV_CONFIG_CHARGER_MP2639A_MODE_GPIO_INVERTED (1)
...
#define PBDRV_CONFIG_SYS_CLOCK_RATE                 250000000
