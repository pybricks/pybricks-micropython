...
static const pbio_observer_model_t model_technic_s_angular = {
    ...
    .d_angle_d_torque = -4166,
    .d_speed_d_torque = -11,
    .d_current_d_torque = 3755,
...
static const pbio_observer_model_t model_technic_m_angular = {
    ...
    .d_angle_d_torque = -8991,
    .d_speed_d_torque = -23,
    .d_current_d_torque = 6153,
...
static const pbio_observer_model_t model_technic_l_angular = {
    ...
    .d_angle_d_torque = -36098,
    .d_speed_d_torque = -91,
    .d_current_d_torque = 9538,
...
static const pbio_observer_model_t model_interactive = {
    ...
    .d_angle_d_torque = -7125,
    .d_speed_d_torque = -18,
    .d_current_d_torque = 6534,
...
static const pbio_observer_model_t model_technic_l = {
    ...
    .d_angle_d_torque = -13475,
    .d_speed_d_torque = -34,
    .d_current_d_torque = 7775,
...
static const pbio_observer_model_t model_technic_xl = {
    ...
    .d_angle_d_torque = -12545,
    .d_speed_d_torque = -32,
    .d_current_d_torque = 7133,
...
static const pbio_observer_model_t model_movehub = {
    ...
    .d_angle_d_torque = -9449,
    .d_speed_d_torque = -24,
    .d_current_d_torque = 6229,
...
static const pbio_observer_model_t model_ev3_l = {
    ...
    .d_angle_d_torque = -73043,
    .d_speed_d_torque = -183,
    .d_current_d_torque = 22485,
...
static const pbio_observer_model_t model_ev3_m = {
    ...
    .d_angle_d_torque = -15426,
    .d_speed_d_torque = -39,
    .d_current_d_torque = 10589,
