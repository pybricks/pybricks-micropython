...
from ev3devices_c import Motor, InfraredSensor, ColorSensor, TouchSensor, UltrasonicSensor, GyroSensor
...
class TouchSensorOld(Ev3devSensor):
...
class GyroSensorOld(Ev3devUartSensor):
